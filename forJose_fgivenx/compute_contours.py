...
xmin = 0.       # minimum of x range
xmax = 3.       # maximum of x range 

ny   = 100       # resolution in y direction (this is normally sufficient) 
ymin = ymin        # minimum of y range        
ymax = ymax       # maximum of y range        
...
chains_file = 'chains/'+file_in  # where the chains are kept
root        = file_in            # the root name for the other files
